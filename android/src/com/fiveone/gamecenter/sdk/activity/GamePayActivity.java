...
public class GamePayActivity extends Activity {
	...
	private void initPayView() {
		...
		String url = NetConnectService.getPayWebViewUrl(this, Config.GAME_CENTER_APP_KEY, Config.GAME_CENTER_PRIVATE_KEY, GameCenterService.ServerID, String.valueOf(GameCenterService.UserInfo.getUserId()),GameCenterService.GamePayCallBackInfo);
